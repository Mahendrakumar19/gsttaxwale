...
export default function TrademarkRegistrationPage() {
  const features = [
    ...
    'Renewal assistance & tracking',
    '10-year protection validity',
    'Multi-class registration support',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-950 text-white">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-block px-4 py-2 bg-pink-500/20 border border-pink-500/50 rounded-full mb-4">
              <span className="text-pink-300 text-sm font-semibold">IP Protection</span>
            </div>
            <h1 className="text-5xl font-bold mb-4 text-white">Trademark Registration</h1>
            <p className="text-xl text-slate-300 mb-6">
              Intellectual property protection through professional trademark registration and maintenance services.
            </p>
            <div className="text-4xl font-bold text-pink-400 mb-8">
              ₹3,999 <span className="text-sm text-slate-400">/filing</span>
            </div>
            <button className="px-8 py-3 bg-gradient-to-r from-pink-600 to-rose-500 text-white rounded-lg hover:from-pink-700 hover:to-rose-600 font-semibold flex items-center gap-2 transition">
              <ShoppingCart size={20} />
              Subscribe Now
            </button>
          </div>

          <div className="bg-gradient-to-br from-pink-900/40 to-pink-800/20 border border-pink-500/30 rounded-lg p-8 backdrop-blur">
            <h3 className="text-2xl font-bold text-pink-300 mb-6">What's Included</h3>
