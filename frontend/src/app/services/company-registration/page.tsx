        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-block px-4 py-2 bg-purple-500/20 border border-purple-500/50 rounded-full mb-4">
              <span className="text-purple-300 text-sm font-semibold">Business Setup</span>
            </div>
            <h1 className="text-5xl font-bold mb-4 text-white">Company Registration & ROC Filing</h1>
            <p className="text-xl text-slate-300 mb-6">
              Complete company incorporation and annual ROC filing services with expert compliance guidance.
            </p>
            <div className="text-4xl font-bold text-purple-400 mb-8">
              ₹4,999 <span className="text-sm text-slate-400">/year</span>
            </div>
            <button className="px-8 py-3 bg-gradient-to-r from-purple-600 to-pink-500 text-white rounded-lg hover:from-purple-700 hover:to-pink-600 font-semibold flex items-center gap-2 transition">
              <ShoppingCart size={20} />
              Subscribe Now
            </button>
          </div>

          <div className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 border border-purple-500/30 rounded-lg p-8 backdrop-blur">
            <h3 className="text-2xl font-bold text-purple-300 mb-6">What's Included</h3>
